...
<head>
    ...
    <link type="text/css" href="cartstyle.php" rel="stylesheet">
</head>
...
<?php 
   ...
   function cartElement($prod_img, $prod_name, $sellPr, $prod_id){
    $element = "
    <form action=\"car.php?action=remove&id=$prod_id\" method=\"post\" class=\"cart-items\">
        <center><img src=$prod_img alt=\"Image1\" class=\"img-fluid\"></center>
        <div class=\"title\">$prod_name
        <div class=\"title\"> Rs.$sellPr
...
<div class="title" style="color:black;font-size:22px;"><b>My Cart<b></div>
<?php
    $total = 0;
    if (isset($_SESSION['cart'])){
        ...
        echo "<h5 class=\"title\">Cart is Empty</h5>";
    }          
?>
<h6 style="text-align:center;font-size:22px;">PRICE DETAILS</h6>
<?php
        if (isset($_SESSION['cart'])){
        ...
        echo "<h6>Amount Payable</h6>";
        echo "<h6>Rs. $total </h6>";
        echo"<input type=\"hidden\"  name=\"count\" value=\"$count\">";
        echo"<input type=\"hidden\"  name=\"tolPr\" value=\"$total\">";
        ...
        echo"<input type=\"submit\" name=\"chk\" value=\"Checkout\">";
        echo"</form>";
